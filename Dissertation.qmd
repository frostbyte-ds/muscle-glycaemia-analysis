...
Some values of this final physical activity variable exceeded 1440 minutes (24 hours). This, of course, is not plausible, so these values were set to `NA` for imputation.
